...
const themes = [
    {
        ...
        sectionBg: "#ffffff", sectionText: "#1a1a1a",
        cardBg: "#ffffff", cardText: "#1a1a1a"
    },
    {
    ...
    },
    {
        ...
        sectionBg: "#ffffff", sectionText: "#111",
        cardBg: "#ffffff", cardText: "#111"
    }
];
...
function applyRandomDesign() {
    ...
    document.body.style.setProperty("--shadow", "0 8px 20px rgba(0,0,0,0.08)");
...
const components = {
    ...
    about: [
        () => `<section class="about"><h2>About me</h2><p>${texts[Math.floor(Math.random() * texts.length)]}</p></section>`,
        () => `<section class="about img-left">
                <img src="https://picsum.photos/400/300?random=${Math.random()}">
                <div><h2>Who I am</h2><p>${texts[Math.floor(Math.random() * texts.length)]}</p></div>
              </section>`
    ],
    gallery: [
    ...
    pricing: [
        () => `<section class="pricing">
                ...
                <div class="card"><h3>Pro</h3><p>${texts[Math.floor(Math.random() * texts.length)]}</p><strong>49€</strong></div>
    ...
    shop: [
        () => `<section class="shop">
            ${Array.from({length: 3}).map(() => `
              <div class="card">
                <img src="https://picsum.photos/250/200?random=${Math.random()}">
                <h3>Product</h3>
